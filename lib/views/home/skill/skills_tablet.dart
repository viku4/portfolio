...
class SkillTablet extends StatefulWidget {
  final GlobalKey skillsKey;
  const SkillTablet({super.key, required this.skillsKey});

  @override
  State<SkillTablet> createState() => _SkillTabletState();
}

class _SkillTabletState extends State<SkillTablet> {
