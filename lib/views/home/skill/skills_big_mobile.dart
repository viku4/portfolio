...
class SkillBigMobile extends StatefulWidget {
  final GlobalKey skillsKey;
  const SkillBigMobile({super.key, required this.skillsKey});

  @override
  State<SkillBigMobile> createState() => _SkillBigMobileState();
}

class _SkillBigMobileState extends State<SkillBigMobile> {
