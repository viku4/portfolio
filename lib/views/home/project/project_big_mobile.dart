...
class ProjectBigMobile extends StatefulWidget {
  final GlobalKey projectKey;
  const ProjectBigMobile({super.key, required this.projectKey});

  @override
  State<ProjectBigMobile> createState() => _ProjectBigMobileState();
}

class _ProjectBigMobileState extends State<ProjectBigMobile> {
